  ...
  try {
    ...
    return {
      ...
      preferences: {
        ...
        dinnerHour: (prefsData.dinnerHour as number) ?? 18.5,
  ...
  try {
    await Promise.all([
      ...
      supabase.from("profiles").update({
        preferences: { workStartHour: 8, workEndHour: 18, lunchHour: 12, dinnerHour: 18.5, workoutTime: "morning", defaultTaskDuration: 30 } as unknown as Record<string, unknown>,
